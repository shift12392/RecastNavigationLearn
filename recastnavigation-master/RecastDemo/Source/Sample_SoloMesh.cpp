...
bool Sample_SoloMesh::handleBuild()
{
	...
	// 从这里可以看出bound box的宽度可能和m_cfg.width* m_cfg.cs不一样。
	...
	//
	// Step 2. Rasterize input polygon soup.  步骤2：光栅化输入的多边形
	//
	...
	//
	// Step 3. Filter walkables surfaces.  步骤3：过滤可行走的表面
	//
